document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectGalleries = {
        felipe: Array.from({ length: 9 }, (_, i) => `./img/Projetos/Felipe_araujo/Felipe Araujo_${i + 1}.png`),
        ana: Array.from({ length: 13 }, (_, i) => `./img/Projetos/Ana_moreno/Ana Moreno Design_${i + 1}.png`),
